...
(async () => {
  ...
  const r = await c.query(
    "SELECT column_name,data_type,character_maximum_length FROM information_schema.columns WHERE table_schema='payload' AND table_name='users' ORDER BY ordinal_position"
  );
